...
`)
  ...
  // 助力
  let res = [], res2 = [];
  $.innerInviteList = await getAuthorShareCode('https://raw1.githubusercontent.com/smiek2221/updateTeam/master/areCodes/wealth_island_code_one.json');
  res2 = await getAuthorShareCode('https://raw1.githubusercontent.com/smiek2221/updateTeam/master/areCodes/wealth_island_code.json');
  $.InviteLists = []
  if (HelpAuthorFlag) {
