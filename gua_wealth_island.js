...
`)
  ...
  $.InviteLists = []
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('https://ra1w.githubusercontent.com/smiek2221/updateTeam/master/shareCodes/wealth_island_code_one.json');
    res2 = await getAuthorShareCode('https://ra1w.githubusercontent.com/smiek2221/updateTeam/master/shareCodes/wealth_island_code.json');
