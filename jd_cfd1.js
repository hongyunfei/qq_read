...
!(async () => {
  ...
  await requestAlgo();
  let res = await getAuthorShareCode('https://111raw.githubusercontent.com/Aaron-lv/updateTeam/master/shareCodes/cfd.json')
  if (!res) {
    $.http.get({url: 'https://111purge.jsdelivr.net/gh/Aaron-lv/updateTeam@master/shareCodes/cfd.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://111cdn.jsdelivr.net/gh/Aaron-lv/updateTeam@master/shareCodes/cfd.json')
  }
